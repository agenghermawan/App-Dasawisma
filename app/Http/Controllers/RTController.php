...
class RTController extends Controller
{
    ...
    public function tambahKeluarga()
    {
        ...
        return view('RT.Keluarga.TambahKeluarga',compact('dataKepalaKeluarga'));
    }
    ...
    {
        $data = WARGA::with('rt')->where('Status_kk','KepalaRumahTangga')->get();
        return view('RT.Warga.daftarWarga',compact('data'));
    }

    public function tambahWarga()
    {
        return view('RT.Warga.TambahWarga');
    }
    ...
    {
        $getNama = WARGA::all();
        return view('RT.Kelahiran.TambahKelahiran',compact('getNama'));
    }
    ...
    public function detailKelahiran($id)
    {
        ...
        $getAlamat = RT::where('user_id',$getUserID)->first();
    ...
    {
        return view('RT.Warga.TambahAnggotaWarga');
    }
    ...
    {
        return view('RT.Kematian.tambah');
    }
